...
@Entity
@DiscriminatorValue("OPPOSITE_HITTER")
public class OppositeHitter extends Player {
    ...
    public OppositeHitter() {
        super();
    }

    public OppositeHitter(String name, int price, int spikes, int blocks, int serviceAces, int attackErrors) {
        super(name, price);
        this.spikes = spikes;
        this.blocks = blocks;
